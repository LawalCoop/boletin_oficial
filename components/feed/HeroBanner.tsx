      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex items-center justify-center lg:justify-end gap-3 sm:gap-4 lg:gap-6 overflow-x-auto pb-2 lg:pb-0 shrink-0">
            {/* Boletín Oficial */}
            <div className="flex flex-col items-center gap-2 shrink-0 animate-[fadeIn_0.5s_ease-out_0.1s_both]">
              ...
              <div className="text-center">
                <span className="text-xs sm:text-sm text-text-secondary font-medium block">
                  Boletín Oficial
                </span>
                <span className="text-[10px] sm:text-xs text-text-muted hidden sm:block">
                  lenguaje técnico/legal
                </span>
              </div>
            </div>

            <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 text-accent shrink-0 animate-[fadeIn_0.5s_ease-out_0.3s_both,pulse_2s_ease-in-out_infinite]" />

            {/* IA */}
            <div className="flex flex-col items-center gap-2 shrink-0 animate-[fadeIn_0.5s_ease-out_0.5s_both]">
              ...
              <div className="text-center">
                <span className="text-xs sm:text-sm font-medium text-accent block">
                  IA procesa
                </span>
                <span className="text-[10px] sm:text-xs text-text-muted hidden sm:block">
                  traduce y clasifica
            ...
            <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 text-accent shrink-0 animate-[fadeIn_0.5s_ease-out_0.7s_both,pulse_2s_ease-in-out_infinite]" />

            {/* entreLín[IA]s */}
            <div className="flex flex-col items-center gap-2 shrink-0 animate-[fadeIn_0.5s_ease-out_0.9s_both]">
